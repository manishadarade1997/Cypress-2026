...
class AllureCypress {
  constructor() {
    ...
    _classPrivateFieldInitSpec(this, _startHook, (context, _ref4) => {
      ...
      var scope = isEach ? context.testScope : (0, _utils.last)(context.suiteScopes);
      if (scope) {
    ...
    _classPrivateFieldInitSpec(this, _stopHook, (context, _ref5) => {
      ...
      if (fixtureUuid) {
        this.allureRuntime.updateFixture(fixtureUuid, fixture => {
          var _fixture$status;
          (_fixture$status = fixture.status) !== null && _fixture$status !== void 0 ? _fixture$status : fixture.status = _allureJsCommons.Status.PASSED;
        });
    ...
    _classPrivateFieldInitSpec(this, _addNewTestResult, (context, fullNameSuffix, _ref7, scopes) => {
      ...
      var posixPath = (0, _reporter.getPosixPath)(context.specPath);
      return this.allureRuntime.startTest(_objectSpread({
        stage: _allureJsCommons.Stage.RUNNING,
        labels: [(0, _reporter.getLanguageLabel)(), (0, _reporter.getFrameworkLabel)("cypress"), ...(0, _reporter.getSuiteLabels)(context.suiteNames), ...metadataLabels, ...(0, _reporter.getEnvironmentLabels)(), (0, _reporter.getHostLabel)(), (0, _reporter.getThreadLabel)(), (0, _reporter.getPackageLabel)(context.specPath)],
        fullName: "".concat(posixPath, "#").concat(fullNameSuffix),
    ...
    _classPrivateFieldInitSpec(this, _passTest, context => {
      ...
      if (testUuid) {
        this.allureRuntime.updateTest(testUuid, testResult => {
          testResult.status = _allureJsCommons.Status.PASSED;
        });
      }
    });
    _classPrivateFieldInitSpec(this, _skipTest, (context, _ref9) => {
      ...
      if (testUuid) {
        this.allureRuntime.updateTest(testUuid, testResult => {
          testResult.status = _allureJsCommons.Status.SKIPPED;
          if (statusDetails) {
    ...
    _classPrivateFieldInitSpec(this, _addSkippedTest, (context, _ref0) => {
      var {
          data: {
            fullNameSuffix,
            suites,
        ...
        testResultData = _objectWithoutProperties(_ref0.data, _excluded3);
    ...
    _classPrivateFieldInitSpec(this, _stopTest, (context, _ref1) => {
      var {
        data
      } = _ref1;
      var testUuid = context.test;
    ...
    _classPrivateFieldInitSpec(this, _stopExistingTestResult, (testUuid, _ref10) => {
      var {
        retries,
        duration
      } = _ref10;
    ...
    _classPrivateFieldInitSpec(this, _fixStepStops, _ref11 => {
      var {
        stop,
        steps = []
      } = _ref11;
    ...
    _classPrivateFieldInitSpec(this, _startStep, (context, _ref12) => {
      var {
          id
        } = _ref12,
    ...
    _classPrivateFieldInitSpec(this, _stopStep, (context, _ref13) => {
      var {
          id,
          stop
        } = _ref13,
        properties = _objectWithoutProperties(_ref13, _excluded5);
    ...
    _classPrivateFieldInitSpec(this, _finalizeStep, (context, _ref14) => {
      var {
          id
        } = _ref14,
        properties = _objectWithoutProperties(_ref14, _excluded6);
      var stepUuid = context.stepsByFrontEndId.get(id);
      if (stepUuid) {
        this.allureRuntime.updateStep(stepUuid, r => {
          Object.assign(r, properties);
    ...
    _classPrivateFieldInitSpec(this, _initializeSpecContext, absolutePath => {
      var specPath = (0, _reporter.getRelativePath)(absolutePath);
      var context = {
        specPath,
        test: undefined,
        fixture: undefined,
...
var createRuntimeState = allureConfig => ({
  ...
  initialized: false,
  messages: [],
  testPlan: (0, _reporter.parseTestPlan)(),
  projectDir: (0, _reporter.getProjectRoot)(),
  stepStack: [],
  stepsToFinalize: [],
  nextApiStepId: 0
});
var getRuntimeConfigDefaults = function getRuntimeConfigDefaults() {
  var {
    stepsFromCommands: {
      maxArgumentLength = _utils.DEFAULT_RUNTIME_CONFIG.stepsFromCommands.maxArgumentLength,
      maxArgumentDepth = _utils.DEFAULT_RUNTIME_CONFIG.stepsFromCommands.maxArgumentDepth
    } = _utils.DEFAULT_RUNTIME_CONFIG.stepsFromCommands
  } = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _utils.DEFAULT_RUNTIME_CONFIG;
  return {
    stepsFromCommands: {
      maxArgumentDepth,
      maxArgumentLength
 ...
 * ```
 */
var allureCypress = (on, cypressConfig, allureConfig) => {
